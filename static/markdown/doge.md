...
_Master and maintenance branches are exclusively mutable by release. Planned_
_releases will always have a development branch and pull requests should be_
\*submitted against those. Maintenance branches are there for **bug fixes only,\***
_please submit new features against the development branch with the highest version._
