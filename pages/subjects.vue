<template>
  <div>
    ...
    <div class="flex flex-col flex-wrap justify-around border-t-4 sm:mr-10 border-dark sm:flex-row">
      <subject-item fullHeader="Programmieren & Systemtechnik (POS)"
        description="
      ...
      <subject-item fullHeader="Medientechnik (MEDT)"
        description="
      ...
      <subject-item fullHeader="Netzwerktechnik & Verteilte Systeme (NSVS)" description="
      ...
      <subject-item fullHeader="Datenbanken & Informationssysteme (DBI)"
        description="
      ...
      <subject-item fullHeader="Systemplanung & Projektmanagement (SYP)"
        description="
                In dem Systemplanung und Projektmanagement -Unterricht (SYP) geht es darum die Arbeitsabläufe rund um das Arbeitsfeld System-Engineering via Projekte kennenzulernen.
                Oft werden Projekte sowie deren Planung auch in kleineren Gruppen bewältigt, dabei lernt man auch über agile Herangehensweisen." />


      <subject-item fullHeader="Technische Informatik (TINF)" description="
